locals {
  ...
  env = regexall("sit|uat|prd", local.name_prefix)
}
...
#  default = {
#    prd = "fj-lambdapipeline"
#    uat = "uat-fj-lambdapipeline"
#    sit = "sit-fj-lambdapipeline"
#  }
#}
...
variable "env" {
  ...
  description = "The prefix used before resource names"
  default = {
    prd-fj-lambdapipeline = "Production"
    uat-fj-lambdapipeline = "UAT"
    sit-fj-lambdapipeline = "SIT"
  }
}
...
variable "default_vpc_id" {
  type = map(string)
  default = {
    prd = "vpc-044dd3c34b06ad23a" #SIT - This needs to be replaced by Main acc's VPC eu-west-1
    uat = "vpc-005e344a1d489c637" #Main acc - Stockholm
    sit = "vpc-044dd3c34b06ad23a"
  }
}
...
variable "public_subnet_ids" {
  type = map(set(string))
  default = {
    prd = [ #SIT - This needs to be replaced by Main acc's subnets eu-west-1
      "subnet-0986c494aa261014a",
      "subnet-0e2ba44ee01606bc4",
      "subnet-022e723b01c226385"]
    uat = [ #Main acc - Stockholm
...
variable "db_name" {
  type = map(string)
  default = {
    prd = "fj-lambdapipelinedb"
    uat = "uat-fj-lambdapipelinedb"
    sit = "sit-fj-lambdapipelinedb"
  }
}
